...
export default function ProductCard(product: productInfo & addItemButton) {
 ...
 return (
     <article className="grid grid-cols-2 productCard h-64 flex-initial border-2 rounded max-w-xs">
         ...
         <p className="price text-center mt-5 py-2 px-2 font-bold">{priceString} kr</p>
